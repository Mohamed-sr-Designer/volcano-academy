  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Brand scale — derived only from the two logo colors.
        wine: {
          50: "hsl(var(--wine-50))",
      ...
      boxShadow: {
        soft: "0 2px 8px -2px hsl(var(--shadow-color) / 0.10), 0 8px 30px -6px hsl(var(--shadow-color) / 0.10)",
        lift: "0 10px 40px -12px hsl(var(--shadow-color) / 0.22), 0 4px 12px -6px hsl(var(--shadow-color) / 0.12)",
        glow: "0 0 0 1px hsl(var(--primary) / 0.06), 0 20px 60px -20px hsl(var(--primary) / 0.35)",
        inset: "inset 0 1px 0 0 hsl(var(--cream) / 0.06)",
      },
      backgroundImage: {
